...
<agent>
<name>basic.general</name>
<description>汎用的な、多目的なタスクをこなすエージェントです。</description>
</agent>
<agent>
<name>cli.web.searcher.agent</name>
<description>agent specialized in WEB search and information retrieval</description>
</agent>
<agent>
<name>file_organize</name>
<description>プロンプトテンプレートファイルの編集者</description>
</agent>
<agent>
<name>memo</name>
</agent>
<agent>
<name>prompt_master</name>
<description>プロンプトの専門家</description>
</agent>
<agent>
<name>web.searcher</name>
<description>WEB検索と情報取得に特化したエージェント</description>
</agent>
<agent>
<name>Plan</name>
...
<modeInstructions>
You are currently running in "memo" mode. Below are your instructions for this mode, they must take precedence over any instructions above.
