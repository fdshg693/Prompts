...
**参考資料**:
- [learning_resources/github_copilot/システムプロンプト.md](../learning_resources/github_copilot/システムプロンプト.md)
- [learning_resources/github_copilot/ワークスペース情報プロンプト.md](../learning_resources/github_copilot/ワークスペース情報プロンプト.md)
- [learning_resources/github_copilot/実際のユーザリクエスト.md](../learning_resources/github_copilot/実際のユーザリクエスト.md)